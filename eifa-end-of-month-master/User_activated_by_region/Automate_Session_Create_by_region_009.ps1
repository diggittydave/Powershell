...
Function Branch-PopCtrl{    param(    [string]$branch,    [string]$popCtrl    )    $wshell = New-Object -ComObject wscript.shell    $Pos = [System.Windows.Forms.Cursor]::Position    $x = 370    $y = 10    [System.Windows.Forms.Cursor]::Position = New-Object System.Drawing.Point($x, $y)
    ...
    $wshell.SendKeys("$branch{TAB}")#change {tab} to {Enter} for prod    sleep 1
    $wshell.SendKeys("mgr{TAB}")#comment out for prod    sleep 1
    $wshell.SendKeys("{TAB}")#comment out for prod    sleep 1
    $wshell.SendKeys("eifa{ENTER}")#comment out for prod    sleep 5
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUe21EmcXPX7ZTPQ2wVNKSxi6S
# 9xygggvEMIIFUDCCAzigAwIBAgIBCzANBgkqhkiG9w0BAQsFADBdMQswCQYDVQQG
...
# BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRSJCm+lppT6wSwzXLMgUruC/H3hDAN
# BgkqhkiG9w0BAQEFAASCAQBg+5JwaO20watuswJ+8QngGbIuG+h+nUmL0+ABB3lP
# GqJ+RQXPrFHTyTs+uB2nTzt/1le++8v+01A/YNC14d0J6O/zTmHGtStQvUmSgUZT
# jwFySraBknOyLa7g4o6sovLzoyX0rVR0RxeH47aDO+2BQIH2e/XlaWIxuXrobsTh
# D5G3w8BZyC7BjLKWsrLAgB3aSXcNfWbzlaHoenrTkvNfmtasydlOcwzKKKp7aGsd
# krgQc08S6t5llYupTkN/Gt+MtlNuLxhB40EYLHSKzXns0NngCVglKyp5IVq1W7Fv
# zG1Fz2bR/b7EblCuQT8QoX48j6lG1CvYbHMObeqEgjIi
